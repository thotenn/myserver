...
var translations = map[string]map[string]string{
	"en": {
		...
		"auth.deniedBody":         "This account is not on the allowlist for this dashboard.",
		"auth.tryAnotherAccount":  "Try another account",
		"auth.error.failed":       "Sign-in could not be completed. Please try again.",
		"auth.error.expired":      "The sign-in attempt expired. Please try again.",
	},
	"es": {
		"resources.cpu":           "CPU",
		...
		"time.days":               "dias",
		"time.ago":                "atras",
		"auth.signInPrompt":       "Iniciá sesión para continuar",
		"auth.signInWithGoogle":   "Iniciar sesión con Google",
		"auth.signOut":            "Cerrar sesión",
		"auth.deniedTitle":        "Acceso denegado",
		"auth.deniedBody":         "Esta cuenta no está en la lista de acceso de este panel.",
		"auth.tryAnotherAccount":  "Probar con otra cuenta",
		"auth.error.failed":       "No se pudo completar el inicio de sesión. Intentá de nuevo.",
		"auth.error.expired":      "El intento de inicio de sesión expiró. Intentá de nuevo.",
	},
}
